...
\begin{singletablelist}
	...
	\stlist{2025-2026}{
		\textsc{Title:} \emph{``Digital transition and artificial intelligence in the social and healthcare sector in the Province of Cuneo: dissemination, best practices, and possible developments''}\\
		& \textsc{Budget:} \euro{58,000} -- \textsc{Funder:} \emph{Cassa di Risparmio di Cuneo Foundation} \\
		& \textsc{Objectives:} Analyse the debate on digital technologies in the social and healthcare sectors by quantifying trends and policies, examining tools and their applications, and assessing their socio-economic impacts in the province of Cuneo, Italy..\\
		& \textsc{Role:} co-PI. Within this project, she is supervising a research assistant (Marco Vitturini).\\
		&
	}
	...
	\stlist{2016-2018}{ 
		...
		& \textsc{Role:} Responsible for work-packages aiming at  the development of \emph{(a)}~an approach for the storage of genomic data taking advantage of the ROOT library, and \emph{(b)}~an ensemble approach for the identification of structural variation~\cite{Ali26}. She also conducted the bioinformatics analysis for~\cite{Ros21,Ros24} and supervised a postdoctoral researcher (Nicco\`o Rossi).\\
		&
	}
...
\begin{singletablelist}
	...
	\stlist{2022-2025}{
		...
		& \textsc{Role:} Co-leading researcher in the application of Deep Learning approaches for \emph{(a)}~the extraction reliable clinical information from structured and unstructured data for supporting medical decision~\cite{Con24}, \emph{(b)}~the mapping of morbidity and medical vulnerabilities patterns that exist within communities~\cite{Con25}, and the public health surveillance~\cite{DeL25}. Within this project, she is supervised a PhD student (Sara De Luca), a master student (Francesca Rondinone), and two research assistants (Emanuele Pietropaolo, Giuseppe Martino).\\
		&
	}
