...
\indentp{
	\begin{itemize}
		...
		\bibitem[P6]{Con24} Contaldo S.G., Pietropaolo E., Bosio L., Pernice S., Terrone I., Baccega D., Wang Y., Sahoo R.K., Rizzo G., \textbf{Visconti A.}, Berchialla P., and Beccuti M., \emph{PHeP: TrustAlert Open-Source Platform for Enhancing Predictive Healthcare with Deep Learning}, In proceedings of 19th Computational Intelligence Methods for Bioinformatics and Biostatistics, CIBB 2024, Benevento, Italia, September 4-6, 2025, LNBI 15276, doi:10.1007/978-3-031-89704-7\_16
...
\indentp{
	\begin{itemize}
		...
		\bibitem[PP4]{Sta25} Standl M.$^{\textbf{$\dag $}}$, Budu-Aggrey A.$^{\textbf{$\dag $}}$, Johnston L.J., Elias M.S., \dots, \textbf{Visconti A.}, \dots, Langan  S.M.$^{\textbf{$\ddag $}}$, Paternoster L.<$^{\textbf{$\ddag $}}$, and Brown S.J.<$^{\textbf{$\ddag $}}$, \emph{Gene-environment interaction analysis in atopic eczema: evidence from large population datasets and modelling in vitro}, medRxiv, 2025, doi:10.1101/2025.01.24.25321071
