...
\noindent
\textsc{\textbf{Research Fellow}}, Department of Twin Research \& Genetics Epidemiology\\
...
\begin{doubletablelist}
	...
	\dtlist{Jan 2009 - Dec 2011}{\textbf{PhD student} at the School of Science and High Technology, University of Turin, Italy.
...
\begin{doubletablelist}
    \dtlist{Jan 2012 - Dec 2013}{\textbf{2 years postdoctoral fellowship} awarded by the Italian Minister of Education, University and Research} 
	\dtlist{Jan 2009 - Dec 2011}{\textbf{3 years PhD fellowship} awarded by the Italian Minister of Education, University and Research (best PhD project)}
\end{doubletablelist}
...
\begin{itemize}
	...
	\bulletitem\rule{1mm}{0pt}  \begin{minipage}{0.91\textwidth}
		\textsc{\textbf{Title:}} \emph{``Understanding phenotype and mechanisms of spontaneous preterm birth in sub-Saharan Africa (PRECISE-SPTB)''}\\
		\textsc{\textbf{Funder:}} \emph{MRC} -- 2021-2024\\
		\textsc{\textbf{Role:}} Named bioinformatics instructor,  contribution to project proposal
	\end{minipage}

	\bulletitem\rule{1mm}{0pt}  \begin{minipage}{0.91\textwidth}
		\textsc{\textbf{Title:}} \emph{``A multi-omics study to dissect the role of the gut microbiome in IgA nephropathy risk''}\\
		\textsc{\textbf{Funder:}} \emph{King's College London - Peking University Health Science Centre Joint Institute for Medical Research} -- 2020-2021\\
		\textsc{\textbf{Role:}} Named researcher, co-writer of proposal
	\end{minipage}
	
	\bulletitem\rule{1mm}{0pt}  \begin{minipage}{0.91\textwidth}
		\textsc{\textbf{Title:}} \emph{``Dissecting the mechanisms of immune-mediated inflammation: a systems-immunology approach''}\\
		\textsc{\textbf{Funder:}} \emph{MRC} -- 2019-2021\\
		\textsc{\textbf{Role:}} Researcher
	\end{minipage}
	
	\bulletitem\rule{1mm}{0pt}  \begin{minipage}{0.91\textwidth}
		\textsc{\textbf{Title:}} \emph{``A high resolution map of copy number and structural variation in Qatari genomes and their contribution to quantitative traits and disease''}\\
		\textsc{\textbf{Funder:}} \emph{Qatar Foundation} -- 2016-2018\\
		\textsc{\textbf{Role:}} Named researcher, co-writer of proposal
	\end{minipage}
	
	\bulletitem\rule{1mm}{0pt}  \begin{minipage}{0.91\textwidth}
		\textsc{\textbf{Title:}} \emph{``An integrative genomics approach for non-invasive diagnostic biomarkers discovery in IgA nephropathy''}\\
		\textsc{\textbf{Funder:}} \emph{MRC} -- 2014-2016\\
		\textsc{\textbf{Role:}} Researcher
	\end{minipage}
	
	\bulletitem\rule{1mm}{0pt}  \begin{minipage}{0.91\textwidth}
		\textsc{\textbf{Title:}} \emph{``Senescence and melanoma -- An integrative systems biology approach to characterise the link between reduced biological senescence and melanoma susceptibility''}\\
		\textsc{\textbf{Funder:}} \emph{British Skin Foundation} -- 2013-2015\\
		\textsc{\textbf{Role:}} Researcher
	\end{minipage}
		
	\bulletitem\rule{1mm}{0pt}  \begin{minipage}{0.91\textwidth}
		\textsc{\textbf{Title:}} \emph{``Genomic analysis of Type 2 Diabetes in Qatar, towards diabetes personalized medicine''}\\
		\textsc{\textbf{Funder:}} \emph{Qatar Foundation} -- 2013-2018\\
		\textsc{\textbf{Role:}} Researcher
	\end{minipage}
	
	\bulletitem\rule{1mm}{0pt}  \begin{minipage}{0.91\textwidth}
		\textsc{\textbf{Title:}} \emph{``LIMPET -- Isotropic And Anisotropic Lipophilicity To Model Permeability Of New Therapeutic Peptides''}\\
		\textsc{\textbf{Funder:}} \emph{Compagnia di San Paolo} -- 2012-2013\\
		\textsc{\textbf{Role:}} Named researcher, co-writer of proposal
	\end{minipage}	

	\bulletitem\rule{1mm}{0pt}   \begin{minipage}{0.91\textwidth}
		\textsc{\textbf{Title:}} \emph{``BioBITs -- Developing white and green biotechnologies by converging platforms from biology and information technology towards metagenomics''}\\
		\textsc{\textbf{Funder:}} \emph{Regione Piemonte} -- 2007-2011\\
		\textsc{\textbf{Role:}} Researcher
	\end{minipage}
	
	\bulletitem\rule{1mm}{0pt}  \begin{minipage}{0.91\textwidth}
		\textsc{\textbf{Title:}} \emph{``Realizzazione di modelli informatici per la valorizzazione della qualit\`a e la tracciabilit\`a delle produzioni in specie da frutto coltivate in Piemonte''}\\
		\textsc{\textbf{Funder:}} \emph{Regione Piemonte} -- 2004-2009\\
		\textsc{\textbf{Role:}} Developer
	\end{minipage}
...
\begin{doubletablelist}	
	\dtlist{a.y. 2021/present}{\textbf{Co-supervisor} of Mr Roger Compte Boixader in his PhD project at King's College London.}
	...
	\dtlist{a.y. 2020/21}{\textbf{Co-supervisor} of Ms Raphaela Joos in her MSc project in \emph{Microbiome in Health and Disease} at King's College London. Raphaela's project aims at studying the interaction between the presence of \emph{Lactobacillacee} in the faeces and blood lipid level.}
	\dtlist{a.y. 2020/21}{\textbf{Co-supervisor} of Ms Petra Blackburn in her MSc project in \emph{Microbiome in Health and Disease} at King's College London. Petra's project aims at studying the interaction between the host gene expression and the gut microbiome.}
	\dtlist{a.y. 2020/21}{\textbf{Co-supervisor} of Ms Natalie Falshaw in her MSc project in \emph{Microbiome in Health and Disease} at King's College London. Natalie's project aims at studying the interaction between the host DNA methylome and the gut microbiome.}
	...
	\dtlist{a.y. 2018/2020}{\textbf{Supervisor} of Ms Giulia Piaggeschi during her research visit at King's College London. Giulia's project, which is part of her PhD, aimed at studying cell-specific modification in peripheral blood and their interaction with smoking.}
