...
\begin{singletablelist}
	\stlist{7 Nov 2025}{\emph{``AI nella sanit\`a pubblica: un approccio interpretabile per la gestione dei pazienti''} at the Intelligenza Artificiale, Macchine e Futurismo, opening day of the MSc in Data analysis for the business intelligence and data science, Turin, Italy}
...
\begin{doubletablelist}
		 ...
		 \dtlist{Nov 2025 -- present}{\textbf{Member} of the management committee of the Interdepartmental Research Center for Service-learning (\url{https://www.circle.unito.it})}
...
\begin{doubletablelist}
	...
	\dtlist{Oct 2026 -- present}{Scientist for the Penne Amiche della Scienza Project (\url{https://sites.google.com/view/penne-amiche-della-scienza}). The project follows the format of \emph{"Letters to a Pre-Scientist"}, and aims at encouraging scientific thinking and raise awareness of scientific careers among fourth and fifth graders in elementary school and first and second graders in middle school in Italy\\&}
